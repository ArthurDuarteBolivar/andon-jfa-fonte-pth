...
public interface RealizadoHorariaTabletRepository extends JpaRepository<RealizadoHorariaTabletModel, Integer> {
    ...
    @Query(value = "SELECT SUM(horas10 + horas11 + horas12 + horas13 + horas14 + horas15 + horas16 + horas17 + horas7 + horas8 + horas9) AS total_soma FROM realizadohoraria_tablet;", nativeQuery = true)
    Integer somarTudo();
